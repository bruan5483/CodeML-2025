"""
Enhanced Historical News Scraper for Natural Gas Articles
...
class EnhancedNewsScraper:
    ...
    def translate_text(self, text, target_lang='en'):
        ...
        try:
            # Fallback to MyMemory API (free, 1000 chars/request)
    ...
    def parse_date(self, date_str):
        ...
        # Try to extract YYYYMMDD format (GDELT format)
...
def main():
    ...
    Optional: set NEWSAPI_KEY=your_key (Windows) or export NEWSAPI_KEY=your_key (Mac/Linux)
    """
    
    # Initialize scraper
    scraper = EnhancedNewsScraper(
        newsapi_key='ea3c774f7f404e02bcc26f43f5c3db5c',  # Your API key
